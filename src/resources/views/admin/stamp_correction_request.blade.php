        ...
        <table class="attendance-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('stamp_correction_request.approve', ['attendance_change_request_id' => $row['id']]) }}" class="text-black">詳細</a>
                    </td>
                </tr>
                @empty
        ...
        <table class="attendance-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-gray no-letter-spacing">{{ \Carbon\Carbon::parse($row['requested_at'])->format('Y/m/d') }}</td>
                    <td>
                        <a href="{{ route('admin.attendance.show', ['attendance' => $row['attendance_id']]) }}" class="text-black">詳細</a>
                    </td>
                </tr>
                @empty
